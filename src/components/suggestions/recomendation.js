...
function Recomendation()	{
  ...
  // 2. Initialize the hook
    const handlePrint = useReactToPrint({
      contentRef: printRef, // 3. Note: 'content' is now 'contentRef'
    });
	return (
    <div ref={printRef}>
      ...
      <div className="center-content mx-auto" ref={printRef}>
        <div className="result-header">
          ...
          <div className="d-flex flex-column justify-content-center align-items-center mb-3">
            ...
            <div>
              <button onClick={handlePrint} name="" id="" className="btn btn-primary d-inline-flex align-items-center justify-content-center me-3"  role="button">
